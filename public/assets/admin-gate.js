...
(async () => {
  ...
  try {
    ...
    console.error('[admin-gate] uncaught error:', e);
    renderMessage('Something went wrong', 'An unexpected error happened while checking your sign-in. Reload the page - if it keeps happening, let support know it said: ' + esc(String(e && e.message || e)));
  }
